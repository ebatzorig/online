...
export const GeneralInfoForm = () => {
  ...
  return (
    <Card border="light" className="bg-white shadow-sm mb-4">
      <Card.Body>
        <h5 className="mb-4">Бүртгэх хэсэг</h5>
        <Form>
          <Row>
            <Col md={6} className="mb-3">
              <Form.Group id="firstName">
                <Form.Label>Код</Form.Label>
                <Form.Control required type="text" placeholder="Захиалгын кодоо оруулна уу" />
              </Form.Group>
            </Col>
            <Col md={6} className="mb-3">
              <Form.Group id="phone">
                <Form.Label>Утасны дугаар</Form.Label>
                <Form.Control required type="number" placeholder="9911****" />
              </Form.Group>
            </Col>
          </Row>
